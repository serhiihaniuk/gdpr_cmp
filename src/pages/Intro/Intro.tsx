		...
		<div className="intro">
			...
			<div className="text" tabIndex={0}>
				<p className="text__paragraph">
					Wenn Sie unsere <a href="#" className="link">Webseiten und Applikationen</a> benutzen, werden durch Cookies und
					verschiedene weitere Technologien von uns und Dritten Daten über Sie gesammelt.
				</p>
				<p className="text__paragraph">
					Mehr dazu finden Sie unter Einstellungen. Wenn Sie auf "Akzeptieren" klicken oder dieses
